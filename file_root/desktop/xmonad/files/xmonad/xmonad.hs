...
myWorkspaces = ["Programming", "Browsering", "Debugging", "Operation0", "Operation1", "Operation2", "Operation3", "Mail", "Rdesktop"]
...
myLayout = avoidStruts
    ...
    $ onWorkspace "Operation0" layout_toggle
    $ onWorkspace "Operation1" layout_toggle
    $ onWorkspace "Operation2" layout_toggle
    $ onWorkspace "Operation3" layout_toggle
  ...
  -- layout specific variables
    ...
    layout_tall_spread = spacing 13 $ Tall nmaster delta ratio12
    ...
    layout_rdesktop = spacing defaultSpace $ Tall nmaster delta ratio45
    layout_browse = spacing defaultSpace $ Tall nmaster delta ratio45
    ...
    layout_trinity_column = spacing defaultSpace $ ThreeColMid nmaster delta ratio12
    ...
    -- workspace layouts
    layout_toggle_emacs = toggleLayouts Full (layout_devel ||| layout_tall)
...
myManageHook = composeAll
      ...
      , className =? "Geary" --> doF (W.shift "9")
      , name =? "Microsoft Windows 7 for Working" --> doF (W.shift "9")
      , (role =? "pop-up" <&&> className =? "Google-chrome") -->  doF W.swapDown
